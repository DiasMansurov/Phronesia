...
export const metadata: Metadata = {
  title: "Olympiad Organizer Results",
...
export default async function OlympiadAdminPage() {
    ...
    return (
      <section className="shell section auth-page">
        <div className="panel stack-md">
          <p className="eyebrow">Olympiad Results</p>
  ...
  if (!organizer.ok && organizer.reason === "signed_out") {
    redirect("/sign-in?redirect_url=/olympiad/admin");
  }
    ...
    return (
      <section className="shell section auth-page">
        <div className="panel stack-md">
          ...
          <p className="muted">This olympiad results dashboard is available only for the organizer account.</p>
