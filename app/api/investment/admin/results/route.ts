...
function adminTeamApiRow(team: InvestmentAdminTeamResult) {
  return {
    ...
    official_status: team.officialStatus,
    under_review: team.underReview,
    legacy_trades_detected: team.legacyTradesDetected,
    recalculation_failed: team.recalculationFailed,
    corrupted_balance_detected: team.corruptedBalanceDetected,
    ignored_legacy_trades: team.ignoredLegacyTrades,
