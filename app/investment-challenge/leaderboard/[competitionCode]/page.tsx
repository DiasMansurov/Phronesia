...
export default async function InvestmentCompetitionLeaderboardPage() {
  ...
  return (
    <section className="shell section auth-page">
      <div className="panel stack-md">
        ...
        <p className="muted">
          Competition rankings and all-team portfolio values are not visible to student teams. Open your team dashboard
          to see only your own portfolio.
        </p>
